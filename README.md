...
*   **articles-stati** — Система автоматизації контенту. Повний цикл: генерація статей через Anthropic API, перевірка унікальності, створення зображень та публікація в WordPress.
...
*   **python-microservice-repo** — Архітектура та інфраструктура бекенд-сервісів для масштабованих систем.

## Проєкти з AI-сервісами:
Значна частина проектів базується на використанні LLM (Anthropic, OpenAI) для автоматизації інтелектуальних завдань: генерації текстів, аналізу даних та голосових інтерфейсів.
